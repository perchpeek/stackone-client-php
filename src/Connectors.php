...
class Connectors
{
    ...
    public function getConnectorMeta(string $provider, ?string $include = null, ?Options $options = null): Operations\StackoneGetConnectorMetaResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'stackone_get_connector_meta', [], $this->sdkConfiguration->securitySource);
    ...
    public function listConnectorsMeta(?string $include = null, ?Options $options = null): Operations\StackoneListConnectorsMetaResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'stackone_list_connectors_meta', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
