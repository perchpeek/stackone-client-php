...
class StepLog
{
     ...
     *
     * @var ?StepLogRequest $request
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('request')]
    #[\Speakeasy\Serializer\Annotation\Type('\StackOne\client\Models\Components\StepLogRequest|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?StepLogRequest $request = null;

    /**
     * The advanced log response data
     *
     * @var ?StepLogResponse $response
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('response')]
    #[\Speakeasy\Serializer\Annotation\Type('\StackOne\client\Models\Components\StepLogResponse|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?StepLogResponse $response = null;
