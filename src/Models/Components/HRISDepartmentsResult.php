...
class HRISDepartmentsResult
{
    /**
     *
     * @var HRISDepartment $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\StackOne\client\Models\Components\HRISDepartment')]
    public HRISDepartment $data;
