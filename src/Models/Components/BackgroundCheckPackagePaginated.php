...
class BackgroundCheckPackagePaginated
{
    /**
     * $data
     *
     * @var array<BackgroundCheckPackage> $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\StackOne\client\Models\Components\BackgroundCheckPackage>')]
    public array $data;
    ...
    /**
     * @param  array<BackgroundCheckPackage>  $data
