...
class TimeOffPoliciesPaginated
{
    /**
     * $data
     *
     * @var array<TimeOffPolicies> $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\StackOne\client\Models\Components\TimeOffPolicies>')]
    public array $data;
    ...
    /**
     * @param  array<TimeOffPolicies>  $data
     * @param  ?string  $next
