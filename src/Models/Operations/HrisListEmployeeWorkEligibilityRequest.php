...
class HrisListEmployeeWorkEligibilityRequest
{
    /**
     *
     * @var string $id
     ...
     *
     * @var ?HrisListEmployeeWorkEligibilityQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?HrisListEmployeeWorkEligibilityQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?HrisListEmployeeWorkEligibilityQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListEmployeeWorkEligibilityQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
        $this->id = $id;
