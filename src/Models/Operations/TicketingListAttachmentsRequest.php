...
class TicketingListAttachmentsRequest
{
    /**
     ...
     *
     * @var ?TicketingListAttachmentsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?TicketingListAttachmentsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?TicketingListAttachmentsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?TicketingListAttachmentsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
