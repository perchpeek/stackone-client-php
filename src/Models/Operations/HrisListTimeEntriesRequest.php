...
class HrisListTimeEntriesRequest
{
    /**
     ...
     *
     * @var ?HrisListTimeEntriesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?HrisListTimeEntriesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?HrisListTimeEntriesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListTimeEntriesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
