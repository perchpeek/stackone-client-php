...
class HrisListCostCenterGroupsRequest
{
    /**
     ...
     *
     * @var ?HrisListCostCenterGroupsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?HrisListCostCenterGroupsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?HrisListCostCenterGroupsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListCostCenterGroupsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
