...
class AccountingListCompanyJournalsRequest
{
     ...
     *
     * @var ?AccountingListCompanyJournalsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?AccountingListCompanyJournalsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AccountingListCompanyJournalsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?AccountingListCompanyJournalsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
