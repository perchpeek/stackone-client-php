...
class AtsListApplicationStagesResponse
{
    ...
    /**
     * @var \Closure(string): ?AtsListApplicationStagesResponse $next
     */
    public \Closure $next;
    /**
     ...
     * @return ?AtsListApplicationStagesResponse
     */
    public function __call($name, $args): ?AtsListApplicationStagesResponse
    {
        if ($name === 'next') {
