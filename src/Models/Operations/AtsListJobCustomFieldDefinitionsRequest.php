...
class AtsListJobCustomFieldDefinitionsRequest
{
    /**
     ...
     *
     * @var ?AtsListJobCustomFieldDefinitionsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?AtsListJobCustomFieldDefinitionsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AtsListJobCustomFieldDefinitionsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     */
    public function __construct(string $xAccountId, ?array $proxy = null, ?string $fields = null, ?AtsListJobCustomFieldDefinitionsQueryParamFilter $filter = null, ?string $page = null, ?string $next = null, ?string $updatedAfter = null, ?string $syncToken = null, ?bool $raw = false, ?string $pageSize = '25')
    {
