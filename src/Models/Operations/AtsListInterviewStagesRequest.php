...
class AtsListInterviewStagesRequest
{
    /**
     ...
     *
     * @var ?AtsListInterviewStagesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?AtsListInterviewStagesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AtsListInterviewStagesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?AtsListInterviewStagesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null, ?string $syncToken = null)
    {
