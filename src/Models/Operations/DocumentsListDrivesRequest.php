...
class DocumentsListDrivesRequest
{
    /**
     ...
     *
     * @var ?DocumentsListDrivesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?DocumentsListDrivesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?DocumentsListDrivesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?DocumentsListDrivesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
