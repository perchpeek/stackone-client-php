...
class MessagingListConversationMessagesRequest
{
    /**
     ...
     *
     * @var ?MessagingListConversationMessagesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?MessagingListConversationMessagesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?MessagingListConversationMessagesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?MessagingListConversationMessagesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
