...
class AtsListApplicationDocumentCategoriesRequest
{
     ...
     *
     * @var ?AtsListApplicationDocumentCategoriesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?AtsListApplicationDocumentCategoriesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AtsListApplicationDocumentCategoriesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?AtsListApplicationDocumentCategoriesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
