...
class AccountingListCompanyTaxRatesRequest
{
     ...
     *
     * @var ?AccountingListCompanyTaxRatesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?AccountingListCompanyTaxRatesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AccountingListCompanyTaxRatesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?AccountingListCompanyTaxRatesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
