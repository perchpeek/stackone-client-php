...
class TicketingListProjectComponentsRequest
{
    /**
     ...
     *
     * @var ?TicketingListProjectComponentsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?TicketingListProjectComponentsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?TicketingListProjectComponentsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?TicketingListProjectComponentsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
