...
class TicketingListProjectsRequest
{
    /**
     ...
     *
     * @var ?TicketingListProjectsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?TicketingListProjectsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?TicketingListProjectsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?TicketingListProjectsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
