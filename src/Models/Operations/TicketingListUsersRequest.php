...
class TicketingListUsersRequest
{
    /**
     ...
     *
     * @var ?TicketingListUsersQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?TicketingListUsersQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?TicketingListUsersQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?TicketingListUsersQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
