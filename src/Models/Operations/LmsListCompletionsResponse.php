...
class LmsListCompletionsResponse
{
    /**
    ...
    /**
     * @var \Closure(string): ?LmsListCompletionsResponse $next
     */
    public \Closure $next;
    /**
     ...
     * @return ?LmsListCompletionsResponse
     */
    public function __call($name, $args): ?LmsListCompletionsResponse
    {
        if ($name === 'next') {
