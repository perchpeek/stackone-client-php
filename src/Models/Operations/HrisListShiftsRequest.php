...
class HrisListShiftsRequest
{
     ...
     * HRIS Shifts filters
     *
     * @var ?HrisListShiftsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?HrisListShiftsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?HrisListShiftsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListShiftsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
