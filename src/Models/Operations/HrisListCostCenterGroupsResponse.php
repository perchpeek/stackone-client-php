...
class HrisListCostCenterGroupsResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\HRISCostCenterPaginated $hrisCostCenterPaginated = null)
    {
