...
class HrisListTeamGroupsRequest
{
    /**
     ...
     *
     * @var ?HrisListTeamGroupsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?HrisListTeamGroupsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?HrisListTeamGroupsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListTeamGroupsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
