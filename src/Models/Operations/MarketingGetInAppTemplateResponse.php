...
class MarketingGetInAppTemplateResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\InAppTemplateResult $inAppTemplateResult = null, ?array $headers = [])
    {
