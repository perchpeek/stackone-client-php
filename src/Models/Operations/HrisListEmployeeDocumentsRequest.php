...
class HrisListEmployeeDocumentsRequest
{
    /**
     ...
     *
     * @var ?HrisListEmployeeDocumentsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?HrisListEmployeeDocumentsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?HrisListEmployeeDocumentsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListEmployeeDocumentsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
