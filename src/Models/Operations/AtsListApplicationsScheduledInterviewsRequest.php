...
class AtsListApplicationsScheduledInterviewsRequest
{
    /**
     ...
     *
     * @var ?AtsListApplicationsScheduledInterviewsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?AtsListApplicationsScheduledInterviewsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AtsListApplicationsScheduledInterviewsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?AtsListApplicationsScheduledInterviewsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null, ?string $syncToken = null)
    {
