...
class HrisListEmployeeCategoriesResponse
{
    /**
    ...
    /**
     * @var \Closure(string): ?HrisListEmployeeCategoriesResponse $next
     */
    public \Closure $next;
    /**
     ...
     * @return ?HrisListEmployeeCategoriesResponse
     */
    public function __call($name, $args): ?HrisListEmployeeCategoriesResponse
    {
        if ($name === 'next') {
