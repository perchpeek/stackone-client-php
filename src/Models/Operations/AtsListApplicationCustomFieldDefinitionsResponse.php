...
class AtsListApplicationCustomFieldDefinitionsResponse
{
    ...
    /**
     * @var \Closure(string): ?AtsListApplicationCustomFieldDefinitionsResponse $next
     */
    public \Closure $next;
    /**
     ...
     * @return ?AtsListApplicationCustomFieldDefinitionsResponse
     */
    public function __call($name, $args): ?AtsListApplicationCustomFieldDefinitionsResponse
    {
        if ($name === 'next') {
