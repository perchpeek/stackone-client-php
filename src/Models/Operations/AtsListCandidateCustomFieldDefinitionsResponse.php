...
class AtsListCandidateCustomFieldDefinitionsResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\CustomFieldDefinitionsPaginated $customFieldDefinitionsPaginated = null)
    {
