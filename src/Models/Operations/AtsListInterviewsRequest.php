...
class AtsListInterviewsRequest
{
    /**
    ...
    public ?AtsListInterviewsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AtsListInterviewsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?AtsListInterviewsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null, ?string $syncToken = null)
    {
