...
class IamListUsersRequest
{
     ...
     * @param  ?string  $expand
     */
    public function __construct(string $xAccountId, ?array $proxy = null, ?string $fields = null, ?IamListUsersQueryParamFilter $filter = null, ?string $page = null, ?string $next = null, ?string $updatedAfter = null, ?string $expand = null, ?bool $raw = false, ?string $pageSize = '25')
    {
