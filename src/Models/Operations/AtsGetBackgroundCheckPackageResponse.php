...
class AtsGetBackgroundCheckPackageResponse
{
     ...
     *
     * @var ?Components\BackgroundCheckPackageResult $backgroundCheckPackageResult
     */
    public ?Components\BackgroundCheckPackageResult $backgroundCheckPackageResult = null;
