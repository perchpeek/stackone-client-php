...
class LmsListUsersRequest
{
     ...
     * LMS Users Filter
     *
     * @var ?LmsListUsersQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?LmsListUsersQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?LmsListUsersQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?LmsListUsersQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
