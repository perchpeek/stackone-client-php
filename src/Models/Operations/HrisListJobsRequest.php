...
class HrisListJobsRequest
{
     ...
     *
     * @var ?HrisListJobsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?HrisListJobsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?HrisListJobsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListJobsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
