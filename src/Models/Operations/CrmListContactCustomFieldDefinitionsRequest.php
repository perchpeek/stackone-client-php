...
class CrmListContactCustomFieldDefinitionsRequest
{
    /**
     ...
     *
     * @var ?CrmListContactCustomFieldDefinitionsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?CrmListContactCustomFieldDefinitionsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?CrmListContactCustomFieldDefinitionsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     */
    public function __construct(string $xAccountId, ?array $proxy = null, ?string $fields = null, ?CrmListContactCustomFieldDefinitionsQueryParamFilter $filter = null, ?string $page = null, ?string $next = null, ?string $updatedAfter = null, ?string $syncToken = null, ?bool $raw = false, ?string $pageSize = '25')
    {
