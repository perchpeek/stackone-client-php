...
class AtsListJobApplicationStagesRequest
{
    /**
     ...
     *
     * @var ?AtsListJobApplicationStagesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?AtsListJobApplicationStagesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AtsListJobApplicationStagesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?AtsListJobApplicationStagesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null, ?string $syncToken = null)
    {
