...
class HrisListEmployeeSkillsRequest
{
    /**
     ...
     *
     * @var ?HrisListEmployeeSkillsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?HrisListEmployeeSkillsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?HrisListEmployeeSkillsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListEmployeeSkillsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
