...
class AtsListApplicationDocumentCategoriesResponse
{
    ...
    /**
     * @var \Closure(string): ?AtsListApplicationDocumentCategoriesResponse $next
     */
    public \Closure $next;
    /**
     ...
     * @return ?AtsListApplicationDocumentCategoriesResponse
     */
    public function __call($name, $args): ?AtsListApplicationDocumentCategoriesResponse
    {
        if ($name === 'next') {
