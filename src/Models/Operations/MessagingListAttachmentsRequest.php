...
class MessagingListAttachmentsRequest
{
    /**
     ...
     *
     * @var ?MessagingListAttachmentsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?MessagingListAttachmentsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?MessagingListAttachmentsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?MessagingListAttachmentsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
