...
class AtsListApplicationScorecardsRequest
{
    /**
     ...
     *
     * @var ?AtsListApplicationScorecardsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?AtsListApplicationScorecardsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AtsListApplicationScorecardsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?AtsListApplicationScorecardsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null, ?string $syncToken = null)
    {
