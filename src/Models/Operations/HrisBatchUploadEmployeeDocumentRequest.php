...
class HrisBatchUploadEmployeeDocumentRequest
{
    ...
    /**
     *
     * @var Components\HrisBatchDocumentUploadRequestDto $hrisBatchDocumentUploadRequestDto
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\HrisBatchDocumentUploadRequestDto $hrisBatchDocumentUploadRequestDto;
