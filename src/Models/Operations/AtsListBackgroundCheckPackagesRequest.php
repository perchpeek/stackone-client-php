...
class AtsListBackgroundCheckPackagesRequest
{
    /**
     ...
     *
     * @var ?AtsListBackgroundCheckPackagesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=form,explode=true,name=filter')]
    public ?AtsListBackgroundCheckPackagesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AtsListBackgroundCheckPackagesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?AtsListBackgroundCheckPackagesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
