...
class HrisListEmployeeTimeOffBalancesRequest
{
    /**
     ...
     *
     * @var ?HrisListEmployeeTimeOffBalancesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?HrisListEmployeeTimeOffBalancesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?HrisListEmployeeTimeOffBalancesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?HrisListEmployeeTimeOffBalancesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null, ?string $expand = null)
    {
