...
class AtsListCandidatesRequest
{
    /**
     ...
     *
     * @var ?AtsListCandidatesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?AtsListCandidatesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?AtsListCandidatesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?AtsListCandidatesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null, ?string $syncToken = null, ?string $include = null)
    {
