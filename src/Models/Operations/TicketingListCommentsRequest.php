...
class TicketingListCommentsRequest
{
    /**
     ...
     *
     * @var ?TicketingListCommentsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?TicketingListCommentsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?TicketingListCommentsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, string $id, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?TicketingListCommentsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
