...
class LmsListCompletionsRequest
{
    /**
     ...
     *
     * @var ?LmsListCompletionsQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?LmsListCompletionsQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?LmsListCompletionsQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?LmsListCompletionsQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
