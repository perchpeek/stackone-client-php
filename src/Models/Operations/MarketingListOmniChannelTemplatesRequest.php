...
class MarketingListOmniChannelTemplatesRequest
{
    /**
     ...
     *
     * @var ?MarketingListOmniChannelTemplatesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?MarketingListOmniChannelTemplatesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?MarketingListOmniChannelTemplatesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?MarketingListOmniChannelTemplatesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
