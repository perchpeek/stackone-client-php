...
class AtsListApplicationNotesResponse
{
    ...
    /**
     * @var \Closure(string): ?AtsListApplicationNotesResponse $next
     */
    public \Closure $next;
    /**
     ...
     * @return ?AtsListApplicationNotesResponse
     */
    public function __call($name, $args): ?AtsListApplicationNotesResponse
    {
        if ($name === 'next') {
