...
class LmsListCoursesRequest
{
    ...
    public ?LmsListCoursesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?LmsListCoursesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?LmsListCoursesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
