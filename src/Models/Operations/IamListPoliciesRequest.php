...
class IamListPoliciesRequest
{
     ...
     *
     * @var ?IamListPoliciesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?IamListPoliciesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?IamListPoliciesQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?IamListPoliciesQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null, ?string $expand = null)
    {
