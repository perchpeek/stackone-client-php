...
class MessagingListUsersRequest
{
    /**
     ...
     *
     * @var ?MessagingListUsersQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?MessagingListUsersQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?MessagingListUsersQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?MessagingListUsersQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null)
    {
