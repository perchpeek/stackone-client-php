...
class AtsRejectApplicationRequest
{
    ...
    /**
     *
     * @var Components\AtsRejectApplicationRequestDto $atsRejectApplicationRequestDto
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\AtsRejectApplicationRequestDto $atsRejectApplicationRequestDto;
