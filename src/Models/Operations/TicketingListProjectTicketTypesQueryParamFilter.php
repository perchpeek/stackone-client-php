...
/** TicketingListProjectTicketTypesQueryParamFilter - Filter parameters that allow greater customisation of the list response */
class TicketingListProjectTicketTypesQueryParamFilter
{
    /**
