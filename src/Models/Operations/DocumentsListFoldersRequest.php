...
class DocumentsListFoldersRequest
{
     ...
     *
     * @var ?DocumentsListFoldersQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?DocumentsListFoldersQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?DocumentsListFoldersQueryParamFilter  $filter
     * @param  ?string  $page
     ...
     * @phpstan-pure
     */
    public function __construct(string $xAccountId, ?bool $raw = null, ?array $proxy = null, ?string $fields = null, ?DocumentsListFoldersQueryParamFilter $filter = null, ?string $page = null, ?string $pageSize = null, ?string $next = null, ?\DateTime $updatedAfter = null, ?string $folderId = null, ?string $include = null, ?string $nestedItems = 'false')
    {
