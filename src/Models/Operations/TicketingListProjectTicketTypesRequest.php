...
class TicketingListProjectTicketTypesRequest
{
    /**
     ...
     *
     * @var ?TicketingListProjectTicketTypesQueryParamFilter $filter
     */
    #[SpeakeasyMetadata('queryParam:style=deepObject,explode=true,name=filter')]
    public ?TicketingListProjectTicketTypesQueryParamFilter $filter = null;
     ...
     * @param  ?string  $fields
     * @param  ?TicketingListProjectTicketTypesQueryParamFilter  $filter
     * @param  ?string  $page
