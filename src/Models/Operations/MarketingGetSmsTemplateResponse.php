...
class MarketingGetSmsTemplateResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\SmsTemplateResult $smsTemplateResult = null, ?array $headers = [])
    {
