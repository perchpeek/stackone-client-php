...
class CrmListContactCustomFieldDefinitionsResponse
{
    ...
    /**
     * @var \Closure(string): ?CrmListContactCustomFieldDefinitionsResponse $next
     */
    public \Closure $next;
    /**
     ...
     * @return ?CrmListContactCustomFieldDefinitionsResponse
     */
    public function __call($name, $args): ?CrmListContactCustomFieldDefinitionsResponse
    {
        if ($name === 'next') {
