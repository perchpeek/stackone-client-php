...
class Screening
{
    ...
    public function createScreeningOrder(Components\ScreeningCreateOrderRequestDto $screeningCreateOrderRequestDto, string $xAccountId, ?Options $options = null): Operations\ScreeningCreateScreeningOrderResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'screening_create_screening_order', null, $this->sdkConfiguration->securitySource);
    ...
    public function getScreeningPackage(Operations\ScreeningGetScreeningPackageRequest $request, ?Options $options = null): Operations\ScreeningGetScreeningPackageResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'screening_get_screening_package', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
    ...
    private function listScreeningPackagesIndividual(Operations\ScreeningListScreeningPackagesRequest $request, ?Options $options = null): Operations\ScreeningListScreeningPackagesResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'screening_list_screening_packages', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
    ...
    public function webhookScreeningResult(Components\ScreeningResultWebhook $screeningResultWebhook, string $xAccountId, ?Options $options = null): Operations\ScreeningWebhookScreeningResultResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'screening_webhook_screening_result', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
