...
class Actions
{
    ...
    private function listActionsMetaIndividual(?Operations\StackoneListActionsMetaRequest $request = null, ?Options $options = null): Operations\StackoneListActionsMetaResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'stackone_list_actions_meta', null, $this->sdkConfiguration->securitySource);
    ...
    public function rpcAction(Components\ActionsRpcRequestDto $request, ?Options $options = null): Operations\StackoneRpcActionResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'stackone_rpc_action', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
